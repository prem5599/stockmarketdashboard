(function ($) {
  ...
  if ($("#visit-sale-chart").length) {
    ...
    new Chart(ctx, {
      type: 'bar',
      data: {
        labels: ['JAN', 'FEB', 'sddd', 'APR', 'MAY', 'JUN', 'JUL', 'AUG'],
        datasets: [{
          label: "Investments",
  ...
  if ($("#traffic-chart").length) {
    ...
    var gradientStrokeViolet = graphGradient4.createLinearGradient(0, 0, 0, 181);
    gradientStrokeViolet.addColorStop(0, 'rgba(218, 140, 255, 1)');
    gradientStrokeViolet.addColorStop(1, 'rgba(154, 85, 255, 1)');
    var gradientLegendViolet = ' rgba(218, 140, 255, 1)';
    ...
    new Chart(ctx, {
      type: 'doughnut',
      data: {
        labels: ['ITC 8%', 'UPL 10%', 'IDFC 80%', 'VBL 2%',],
        datasets: [{
          data: [4, 5, 80, 1.8],
